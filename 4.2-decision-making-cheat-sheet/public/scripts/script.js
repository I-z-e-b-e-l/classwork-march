...
// DIRECTIONS: Write an if statement that will print the following message in a console.log if the conditional statement is true: `The conditional statement is TRUE, so it executed this code.` 
    // You can decide on the expression to use in statement, but use the variables provided above along with a comparison operator to make the statement evaluate to TRUE.   ✔️
...
// DIRECTIONS: Write an if statement to check if varY exists. Print the following message with a console.log if varY exists: `varY exists, and it is: ${varY}` ✔️
...
// DIRECTIONS: Write an if else statement that will print the following message in a console.log if the if conditional statement is true: `The first conditional statement is TRUE, so it executed this code.` 
    ...
    // Then, change the statement so that it evaluates to FALSE, so the second message will print. ✔️
...
// DIRECTIONS: Write a statement that includes an IF, ELSE IF, and ELSE statement. If the first statement evaluates to TRUE, the code should print the following message in a console.log: `The first conditional statement is true, so it executed this code.` ✔️
    // If the first condtional is FALSE, but the second conditional is TRUE, the following message should be printed in an ELSE IF statement: `The first statement was FALSE, but the second statement, in the ELSE IF statement was TRUE, so this message printed.` ✔️
        // If both the IF and the ELSE IF statements evaluate to FALSE, the following message should be printed in a console.log: `The first statement was FALSE, the ELSE IF statement was also FALSE, so this statement printed through the ELSE statement.`✔️
            // Rewrite your statements to get the first message to print, then rewrite to get the second message to print, then rewrite to get the last message to print. ✔️
...
// }else {console.log(`The first statement was FALSE, the ELSE IF statement was also FALSE, so this statement printed through the ELSE statement.`)
// }
...
// EXAMPLE:
// mathAnswer = (13 + 3);
// console.log(`13 added to 3 = ${mathAnswer}`); ✔️

// mathAnswer = (mathX + 15);
// console.log(`mathX added to 15 = ${mathAnswer}`);✔️

// mathAnswer = (mathY - mathZ);
// console.log(`mathY minus mathZ = ${mathAnswer}`); ✔️

// mathAnswer = (mathY * 100);
// console.log(`multiply mathY by 100 = ${mathAnswer}`); ✔️

// mathAnswer = (mathZ**7);
// console.log(`mathZ raised to the power of 7 = ${mathAnswer}`); ✔️

// mathAnswer = (25/mathY);
// console.log(`25 divided by mathY = ${mathAnswer}`); ✔️

// mathAnswer = ();
// console.log(`the remainder of mathY divided by mathZ = ${mathAnswer}`);✨

// mathAnswer = (++mathY);
// console.log(`mathY incremented once = ${mathAnswer}`);✔️

// mathAnswer = (--mathX);
// console.log(`mathX decremented once = ${mathAnswer}`);✔️
...
// DIRECTIONS: console.log the variable "sum" along with its data type below to see type coercion in action: 
// console.log(`The variable sum is: ${sum} and it's a: ${typeof sum}`)
// console.log(sum); 😮
// console.log(typeof(sum));✔️
...
let myAge = 42;
//DIRECTIONS: uncomment out the next line of code to see the variable myAge and its data type in the console: ✔️
// console.log(`myAge is: ${myAge} and it's a: ${typeof myAge}`); 

// DIRECTIONS: reassign the variable myAge to be a string using the String() method. ✔️

// console.log(typeof(String(myAge))) 

// DIRECTIONS: console.log the variable "myAge" along with its data type below to see type coercion in action: 
...
// console.log(typeof(theirAge.toString()))
...
// See above or uncomment

// console.log(typeof(theirAge)
...
console.log(`The userAge is ${userAge} and the data type is ${typeof(Number(userAge))}`)